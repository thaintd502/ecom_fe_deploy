...
const EditUserForm = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        const response = await axios.get(`https://ecom-amwn.onrender.com/api/admin/get-user/${userId}`, {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`https://ecom-amwn.onrender.com/api/admin/edit/${userId}`, editedUser, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
