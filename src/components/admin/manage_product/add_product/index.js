...
const AddProduct = () => {
    ...
    useEffect(() => {
        ...
        const fetchBrands = async () => {
            try {
                ...
                const response = await axios.get('http://localhost:9090/admin/get-all-brands', {
                    headers: {
        ...
        const fetchCategories = async () => {
            try {
                const token = localStorage.getItem('token'); // Get token from localStorage
                const response = await axios.get('http://localhost:9090/admin/get-all-categories', {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
                });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:9090/admin/add-product', formData, {
                headers: {
