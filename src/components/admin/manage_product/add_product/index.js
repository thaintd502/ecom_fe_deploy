...
const AddProduct = () => {
    ...
    useEffect(() => {
        ...
        const fetchBrands = async () => {
            try {
                ...
                const response = await axios.get('http://34.92.164.246:9090/api/admin/get-all-brands', {
                    headers: {
        ...
        const fetchCategories = async () => {
            try {
                const token = localStorage.getItem('token'); // Get token from localStorage
                const response = await axios.get('http://34.92.164.246:9090/api/public/get-all-categories', {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
                });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://34.92.164.246:9090/api/admin/add-product', formData, {
                headers: {
