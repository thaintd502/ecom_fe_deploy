...
const EditProduct = () => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                ...
                const response = await axios.get(`http://34.92.164.246:9090/api/public/product/${productId}`, {
                    headers: {
        ...
        const fetchBrandsAndCategories = async () => {
            try {
                ...
                const [brandsResponse, categoriesResponse] = await Promise.all([
                    axios.get('http://34.92.164.246:9090/api/admin/get-all-brands', {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
                    }),
                    axios.get('http://34.92.164.246:9090/api/public/get-all-categories', {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
                    }),
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await axios.put(`http://34.92.164.246:9090/api/admin/edit-product/${productId}`, formData, {
                headers: {
